...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="row m-5">
        ...
        <div class="col-8 mx-0 px-0">
            ...
            <asp:GridView ID="GridView1" CssClass="text-center col-12 p-3 my-3"  runat="server" AutoGenerateColumns="False" DataKeyNames="jptitle,ID" CellPadding="4" ForeColor="#333333" GridLines="None">
